export class LockOne {
  ...
  public columnDefaultOne: any = ["empty", "empty", "empty", "empty", "empty"],
  public columnDefaultTwo: any = ["empty", "empty", "empty", "empty", "empty"],
  public columnDefaultThree: any = ["empty", "empty", "empty", "empty", "empty"],
